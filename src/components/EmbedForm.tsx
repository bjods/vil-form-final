...
const AddressStep: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Get API key from bundled environment variables
    const apiKey = (window as any).VL_ENV?.VITE_GOOGLE_MAPS_API_KEY;
    ...
    <div className="space-y-4">
      <div>
        ...
        <Input
          ...
          autoComplete="off"
        />
        {(!(window as any).VL_ENV?.VITE_GOOGLE_MAPS_API_KEY || (window as any).VL_ENV?.VITE_GOOGLE_MAPS_API_KEY === 'YOUR_GOOGLE_MAPS_API_KEY_HERE') && (
...
const EmbedForm: React.FC<EmbedFormProps> = ({ onComplete }) => {
    ...
    <>
      <style>
        {`
          ...
          .vl-embed-form input[type="date"]::-webkit-calendar-picker-indicator {
            filter: invert(0.6) sepia(1) saturate(5) hue-rotate(35deg);
          }
          
          .vl-embed-form input[type="date"]:focus::-webkit-calendar-picker-indicator {
            filter: invert(0.4) sepia(1) saturate(5) hue-rotate(35deg);
          }
          
          /* Date picker popup styling - webkit browsers */
          .vl-embed-form input[type="date"]::-webkit-datetime-edit-fields-wrapper {
            color: #374151;
          }
          
          .vl-embed-form input[type="date"]::-webkit-datetime-edit-text {
            color: #6b7280;
          }
          
          .vl-embed-form input[type="date"]::-webkit-datetime-edit-month-field,
          .vl-embed-form input[type="date"]::-webkit-datetime-edit-day-field,
          .vl-embed-form input[type="date"]::-webkit-datetime-edit-year-field {
            color: #374151;
          }
          
          /* Focus styles for date inputs */
          .vl-embed-form input[type="date"]:focus {
            border-color: #d97706;
            box-shadow: 0 0 0 3px rgba(217, 119, 6, 0.1);
          }
        `}
      </style>
      <div className="vl-embed-form w-full max-w-2xl mx-auto" style={{ height: '775px' }}>
